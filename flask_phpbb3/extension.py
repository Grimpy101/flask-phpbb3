...
class PhpBB3:
    ...
    def init_app(
        self, app: flask.Flask, cache: typing.Optional[cachelib.BaseCache] = None
    ) -> None:
        ...
        app.session_interface = flask_phpbb3.sessions.PhpBB3SessionInterface()
    ...
    def _ensure_default_config(cls, app: flask.Flask) -> None:
        ...
        if app.config["PHPBB3_SESSION_BACKEND"]["TYPE"] == "memcached":
            app.config["PHPBB3_SESSION_BACKEND"].setdefault("KEY_PREFIX", "phpbb3")
    ...
    def _backend(self) -> flask_phpbb3.backends.base.BaseBackend:
        ...
        backend: typing.Optional[flask_phpbb3.backends.base.BaseBackend] = flask.g.get(
            "phpbb3_backend", None
        )
    ...
    def get_autologin(
        self, key: str, cache: bool = False, cache_ttl: typing.Optional[int] = None
    ...
    def get_user(
        self, user_id: int, cache: bool = False, cache_ttl: typing.Optional[int] = None
    ) -> typing.Optional[typing.Dict]:
        output: typing.Optional[typing.Dict] = self._backend.execute(
            "get_user",
            user_id=user_id,
    ...
    def fetch_acl_options(
        ...
        output: typing.Optional[typing.List[typing.Dict]] = self._backend.execute(
            "fetch_acl_options",
            skip=skip,
            limit=limit,
            cache=cache,
    ...
    def teardown(self, exception: typing.Any) -> None:
        backend: flask_phpbb3.backends.base.BaseBackend = flask.g.get(
            "phpbb3_backend", None
        )
