...
class TestSessionHasPrivilege(unittest.TestCase):
    ...
    def test_global(self) -> None:
        ...
        # is set to true)
        actual_result = self.user_acl.has_privilege("m_review")
        self.assertFalse(actual_result)
    ...
    def test_local(self) -> None:
        ...
        actual_result = self.user_acl.has_privilege("m_review", forum_id=5)
        self.assertTrue(actual_result)

        # True, because globals are always set
        actual_result = self.user_acl.has_privilege("m_delete", forum_id=5)
        self.assertTrue(actual_result)

        actual_result = self.user_acl.has_privilege("m_edit", forum_id=5)
        self.assertTrue(actual_result)

        actual_result = self.user_acl.has_privilege("m_view", forum_id=5)
        self.assertFalse(actual_result)
    ...
    def test_negated(self) -> None:
        ...
        actual_result = self.user_acl.has_privilege("!m_edit")
        self.assertFalse(actual_result)
    ...
    def test_out_of_bound(self) -> None:
        actual_result = self.user_acl.has_privilege("m_strange")
        self.assertFalse(actual_result)

        actual_result = self.user_acl.has_privilege("m_strange", forum_id=5)
        self.assertFalse(actual_result)

    def test_unknown(self) -> None:
        actual_result = self.user_acl.has_privilege("m_unknown")
        self.assertFalse(actual_result)

        actual_result = self.user_acl.has_privilege("m_unknown", forum_id=5)
        self.assertFalse(actual_result)

        actual_result = self.user_acl.has_privilege("m_unknown", forum_id=2)
        self.assertFalse(actual_result)
...
class TestSessionHasPrivileges(unittest.TestCase):
    ...
    @mock.patch("flask_phpbb3.backends.base.UserAcl.has_privilege", return_value=False)
